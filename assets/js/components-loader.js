...
(function injectMetaPixel() {
  ...
  // Expõe fbq globalmente para ser usado em outras partes do código
  window.hubPixel = { id: PIXEL_ID, track: (event, data) => window.fbq?.('track', event, data) };
})();
